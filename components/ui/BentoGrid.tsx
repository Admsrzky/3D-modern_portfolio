...
export const BentoGridItem = ({
  ...
  spareImg?: string;
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('adimasrizki926@gmail.com');
        setCopied(true);
  ...
  return (
    ...
    >
        <div className={`${id === 6 && 'flex justify-center'} h-full'`}>
            ...
            <div className={cn(
                titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex justify-center flex-col px-5 p-5 lg:p-10'
            )}>
            ...
            {id === 3 && (
                <div className="flex gap-1 lg:gap-6 lg:mt-40 w-fit absolute -right-3 lg:-right-3">
                    <div className="flex flex-col gap-3 lg:gap-6">
                        {['React.js', 'Next.js', 'Typescript'].map
                        ((item) => (
                            <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 
                    ...
                    <div className="flex flex-col gap-3 lg:gap-6">
                    <span className="py-6 lg:-mt-6 px-3 rounded-lg text-center bg-[#10132E]" />
                        {['VueJS', 'PHP', 'MySQL'].map
                        ((item) => (
                            <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 
                            text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg 
